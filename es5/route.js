...
function route(app, ctx) {
    ...
    app.post('/backoffice/films/:id/gallery', parser.single('file'), ctx.backOfficeFilmUpload.uploadGallery);
    ...
    app.post('/my-items/:id/gallery', parser.single('file'), ctx.myitemsUpload.uploadGallery);
