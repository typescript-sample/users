...
function route(app, ctx) {
    ...
    app.get('/my-profile/:id/fetchImageGalleryUploaded', ctx.myprofileUpload.getGallery);
    app.patch('/my-profile/:id', ctx.myprofile.saveMyProfile);
    app.patch('/my-profile/:id/settings', ctx.myprofile.saveMySettings);
    app.post('/my-profile/:id/cover', parser.array('files'), ctx.myprofileUpload.uploadCover);
    app.post('/my-profile/:id/upload', parser.array('files'), ctx.myprofileUpload.uploadImage);
    app.post('/my-profile/:id/gallery', parser.single('files'), ctx.myprofileUpload.uploadGallery);
    ...
    app.post('/my-profile/:id/external-resource', ctx.myprofileUpload.addExternalResource);
    app.delete('/my-profile/:id/external-resource', ctx.myprofileUpload.deleteExternalResource);
    ...
    app.post('/backoffice/films/:id/upload', parser.array('files'), ctx.backOfficeFilmUpload.uploadImage);
    app.post('/backoffice/films/:id/cover', parser.array('files'), ctx.backOfficeFilmUpload.uploadCover);
    app.post('/backoffice/films/:id/gallery', parser.single('files'), ctx.backOfficeFilmUpload.uploadGallery);
    ...
    app.get('/my-items/:id/fetchImageGalleryUploaded', ctx.myitemsUpload.getGallery);
    ...
    app.post('/my-items/:id/upload', parser.array('files'), ctx.myitemsUpload.uploadImage);
    app.post('/my-items/:id/gallery', parser.single('files'), ctx.myitemsUpload.uploadGallery);
