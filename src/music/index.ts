...
export function useMusicController(log: Log, db: DB, mapper?: TemplateMap): QueryController<Music, string, MusicFilter> {
  ...
  return new QueryController<Music, string, MusicFilter>(log, service);
}
